<template>
    <div class="w-full h-screen flex flex-col sm:items-start max-sm:items-center justify-center sm:px-20 max-sm:px-5">
        ...
        <h1 class="font-bold sm:text-4xl max-sm:text-3xl sm:mb-1 max-sm:mb-2">Hi, I'm <span class="text-title">Ira
                celiani</span></h1>
...
export default {
    ...
    data() {
        return {
            img: Image,
            icons: [
                { title: 'Whatsapp', link: 'https://api.whatsapp.com/send/?phone=%2B6282387527727&text&type=phone_number&app_absent=0' },
